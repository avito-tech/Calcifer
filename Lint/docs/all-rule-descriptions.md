...
* [Bool type inference](#bool-type-inference)
...
* [CyrillicAvito](#cyrillicavito)
* [Cyrillic Letters](#cyrillic-letters)
* [DI resolve rule](#di-resolve-rule)
...
* [Empty Tuple Return](#empty-tuple-return)
* [Empty XCTest Method](#empty-xctest-method)
* [Excessive spaces after colon](#excessive-spaces-after-colon)
...
* [Feature toggle import rule](#feature-toggle-import-rule)
...
* [Keyed converter rule](#keyed-converter-rule)
...
* [Mark](#mark)
* [Missing spaces after colon](#missing-spaces-after-colon)
...
* [Redundant spaces before colon](#redundant-spaces-before-colon)
...
* [Self in backticks rule](#self-in-backticks-rule)
* [Setup function name](#setup-function-name)
...
* [String type inference](#string-type-inference)
...
--- | --- | --- | --- | ---
`accessibility_purpose` | Enabled | No | idiomatic | 3.0.0 

Choose between production and test accessibility: qaXxx / userXxx
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`assertion` | Enabled | No | idiomatic | 3.0.0 

Do not use Swift assertions. Use Avito assertions: `avitoAssert`, `avitoAssertionFailure`
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`bool_type_inference` | Enabled | No | style | 3.0.0 

Omit `Bool` type specifier in variable declarations
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`cyrillic_avito` | Enabled | No | idiomatic | 3.0.0 

Вместо Avito пишем Авито
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`cyrillic_letters` | Enabled | No | idiomatic | 3.0.0 

Do not use Cyrillic letters anywhere except strings and comments
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`di_resolve` | Disabled | No | idiomatic | 3.0.0 

Resolve definitions only in Factories and Assemblies.
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`empty_tuple_return` | Enabled | Yes | style | 3.0.0 
...
## Excessive spaces after colon

Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`excessive_spaces_after_colon` | Enabled | Yes | style | 3.0.0 

There must be no more then 1 space or tab after colon
...
## Feature toggle import rule

Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`feature_toggle_import` | Enabled | No | idiomatic | 3.0.0 

Delete unused import of FeatureToggle
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`inset_by` | Enabled | Yes | idiomatic | 3.0.0 

Do not use crashy `insetBy(dx:dy:)`. Use `avitoInsetBy(dx:dy:)`
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`internal_access_modifier` | Enabled | Yes | style | 3.0.0 

Do not use an `internal` access modifier as being a default one
...
## Keyed converter rule

Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`keyed_converter` | Enabled | No | idiomatic | 3.0.0 

Do not use NSKeyerArchiver and NSKeyedUnarchiver, use KeyedConverter instead
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`missing_spaces_after_colon` | Enabled | Yes | style | 3.0.0 

There must be at least 1 space after colon
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`optional_bools` | Enabled | No | idiomatic | 3.0.0 

Do not use optional bools
...
```swift
typealias _Dictionary = [String: Bool]
```
...
```swift
public enum Enum { case bool(Bool) }
```
...
```swift
public enum Enum { case array([Bool]) }
```
...
```swift
public enum Enum { case dictionary([String: Bool]) }
```
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`optional_collections` | Enabled | No | idiomatic | 3.0.0 

Do not use optional collections
...
```swift
public let dictionaries: [[String: Any]]
```
...
```swift
public var dictionaries: [[String: Any]]
```
...
```swift
func foo() -> [[String: Any]] { return nil }
```
...
```swift
typealias _Dictionaries = [[String: Any]]
```
...
```swift
public enum Enum { case array([String]) }
```
...
```swift
public enum Enum { case dictionaries([[String: Any]]) }
```
...
```swift
if let dictionaries = dictionaries as? [[String: Any]] {}
```
...
```swift
let value = dictionary["arrayKey"]?.first
```

```swift
let value = dictionary["dictionaryKey"]?["otherKey"]
```
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`precondition` | Enabled | No | idiomatic | 3.0.0 

Do not use preconditions
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`print` | Enabled | Yes | idiomatic | 3.0.0 

Do not use Swift print functions. Use Avito print: `avitoPrint` and `avitoDebugPrint`
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`protocol_mark` | Enabled | No | idiomatic | 3.0.0 

Add `// MARK: - ProtocolName` for every adopted protocol
...
```swift
final class MyClassNonTriggering: MyProtocol {
...
```swift
enum MyEnumNonTriggering: Int, MyProtocol {
    case some = 100500
...
```swift
struct MyStructNonTriggering: MyProtocol, Equatable {
    // MARK: - Equatable
    static func ==(left: MyStructNonTriggering, right: MyStructNonTriggering) -> Bool {
        return true
    }
...
```swift
protocol MyProtocol: MyProtocolSmall, MyProtocolSmaller {}
final class MyClassTriggering: MyProtocol {
    private let counter = 0
    private let label: String
...
```swift
enum MyEnumTriggering: Int, MyProtocol {
    case some = 100500
}
```

```swift
struct MyStructTriggering2: MyProtocol, Equatable {
    // MARK: - Equatable    static func ==(left: MyStructTriggering2, right: MyStructTriggering2) -> Bool {
        return true
    }
}
```
...
## Redundant spaces before colon

Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`redundant_spaces_before_colon` | Enabled | Yes | style | 3.0.0 

There must be 0 spaces before colon
...
## Self in backticks rule

Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`self_in_backticks` | Enabled | No | idiomatic | 3.0.0 

Do not use self in backticks
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`setup_function_name` | Enabled | Yes | style | 3.0.0 

Prefer verb `setUp` to a noun `setup` if a function sets something up
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`string_type_inference` | Enabled | No | style | 3.0.0 

Omit `String` type specifier in variable declarations
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`sync` | Enabled | No | idiomatic | 3.0.0 

Do not use Swift sync function. Use Avito sync: `avitoSync`
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`tabs` | Enabled | Yes | style | 3.0.0 

Prefer whitespaces to tabs
...
Identifier | Enabled by default | Supports autocorrection | Kind | Minimum Swift Compiler Version
--- | --- | --- | --- | ---
`uicolor` | Enabled | No | idiomatic | 3.0.0 

Do not use UIColor. Use colors from `SpecColors`
